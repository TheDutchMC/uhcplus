...
public class DeathmatchHandler {
	...
	public void startDeathmatch() {
		...
		for (int i = 0; i < teamAliveCount; i++) {
			...
			for (UUID uuid : team.getAliveTeamMembers()) {
				...
				System.out.println(
						"[UhcPlus][Debug][world.DeathmatchHandler: 99] Player: " + player + " Location: " + location);
	...
	void loadSchematic(String deathmatchArena) {
		...
		File schematic = new File(UhcPlus.INSTANCE.getDataFolder() + File.separator + "deathmatch",
				deathmatchArena + ".schem");
